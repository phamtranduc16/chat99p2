...
import com.example.appchat99.adapters.RecentConversationsAdapter;
import com.example.appchat99.databinding.ActivityMainBinding;

import com.example.appchat99.listeners.ConversionListener;
import com.example.appchat99.models.ChatMessage;
...
public class MainActivity extends BaseActivity implements ConversionListener {
    ...
    private void setListeners(){
        ...
        binding.fabNewChat.setOnClickListener(v ->
                startActivity(new Intent(getApplicationContext(),UsersAcivity.class))
                );
    }
